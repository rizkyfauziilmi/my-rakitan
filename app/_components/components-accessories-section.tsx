...
export function ComponentsAccessoriesSection() {
  ...
  return (
    <section className="relative overflow-hidden min-h-screen">
      <div className="absolute inset-0 opacity-10 bg-primary/20 rounded-full blur-3xl" />
      ...
      <div className="mx-auto max-w-6xl relative z-10">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
            Jelajahi katalog lengkap komponen PC premium kami. Temukan bagian
            yang sempurna untuk setiap rakitan atau peningkatan.
          </p>
        </div>

        {/* Category Buttons with Scroll */}
        <div className="mb-16">
          <div className="flex flex-wrap gap-3 pb-4 mb-8 justify-center">
            {componentCategories.map((category, index) => (
              <Button
                ...
                className={`relative px-6 py-3 rounded-lg font-semibold transition-all duration-300 flex items-center gap-2 whitespace-nowrap shrink-0 ${
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          {[
            ...
            <div
              key={index}
              className="p-6 rounded-lg bg-card border border-border text-center hover:border-primary/50 transition-colors"
            >
