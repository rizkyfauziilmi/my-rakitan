...
export default function Footer() {
  return (
    <footer className="bg-primary/10 text-foreground border-t border-muted-foreground mt-14">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Solusi terbaik untuk semua kebutuhan komputermu dengan harga
              bersaing dan layanan pelanggan terbaik.
            </p>
          </div>
